...
<html>
	<head>
		...
		<meta property="og:title" content="Press - Digital Uzu" />
		<meta property="og:url" content="http://digitaluzu.com/press" />
...
if ($handle = opendir('.')) {
	// SHYAM-EDIT: sorting project names
	$entries = array();
...
//	while (false !== ($entry = readdir($handle))) {
		// SHYAM-EDIT: skip projects with this prefix
		if (substr($entry, 0, 5) == "TODO_") {
			continue;
		}
...
/* SHYAM-EDIT: removing videos section for now since we have none.
echo '				<hr>
...
/* SHYAM-EDIT: removing image section for now since we have none.
echo '					<hr>
