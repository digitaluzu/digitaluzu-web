...
<html>
	<head>
		...
		<meta property="og:title" content="'. GAME_TITLE .' Press - Digital Uzu" />
		<meta property="og:site_name" content="Digital Uzu" />

		<title>'. GAME_TITLE .' - '. COMPANY_TITLE .'</title>
...
// SHYAM-EDIT:
if( count($additionals) > 0) echo('<li><a href="#links">Additional Links</a></li>');
echo '
...
echo '					<div class="uk-grid">
						<div class="uk-width-medium-2-6">
							...
							<p>
								';
// SHYAM-EDIT:
if (GAME_TITLE == "BEAT DRIFT") {
echo '
								<strong>Developers:</strong><br/>
								<a href="index.php">'. COMPANY_TITLE .'</a><br/>
								<a href="http://www.lunarpixelgames.com" target="_Blank">LunarPixelGames</a><br/>
								';
}
else {
echo '
...
// SHYAM-EDIT: don't print website if none is supplied
if (GAME_WEBSITE == "GAME_WEBSITE") {
	// ...
}
else {
echo '						<p>
...
if ($name == "") {
	echo '
	<cite>- <a href="http://'.parseLink($link).'">'.$website.'</a></cite></li>';
}
else {
	echo '
	<cite>- '.$name.', <a href="http://'.parseLink($link).'">'.$website.'</a></cite></li>';
...
if (GAME_TITLE == "BEAT DRIFT") {
	echo '
		<p>
			...
			<a href="mailto:feedback@lunarpixelgames.com">feedback@lunarpixelgames.com</a>
		</p>
		<p>
			<strong>Twitter</strong><br/>
			<a href="http://twitter.com/BEATDRIFT">twitter.com/BEATDRIFT</a>
		</p>
		<p>
			<strong>Facebook</strong><br/>
			<a href="http://facebook.com/BEATDRIFT">facebook.com/BEATDRIFT</a>
		</p>
		<p>
			<strong>Web</strong><br/>
			<a href="http://beatdrift.com">beatdrift.com</a>
		</p>
	';
}
else {
...
echo '						</div>
					...
					<hr>
					<p style="margin-bottom: 5px;"><a href="http://digitaluzu.com"><img src="http://digitaluzu.com/wp-content/uploads/DigitalUzuLogo_footer.png" style="margin-left: auto; margin-right: auto; display: block; max-width:160px;"></a></p>
					<p style="text-align:center;margin-top: 0px;margin-bottom: 5px;">Copyright © 2013 - 2015 Digital Uzu, LLC</p>

					<p style="text-align:center;margin-top: 0px;">Presskit powered by <a href="http://dopresskit.com/">presskit()</a></p>
				</div>
			</div>
		</div>
